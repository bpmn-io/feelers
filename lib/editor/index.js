...
import { feelersLinter } from 'feelers/lint';
...
export function FeelersEditor({
  ...
  const feelersLanguageSupport = feelersLanguage(hostLanguageParser || hostLanguage && _getHostLanguageParser(hostLanguage));
 ...
 *
 * @returns {{ ranges: Array }} selection
 */
